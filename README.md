...
Maybe. Most of the metrics only need python to run, which can be done on Windows. However, you might expect errors with METEOR, SPICE and PTB tokenizer, since they requires an external java program to run.
